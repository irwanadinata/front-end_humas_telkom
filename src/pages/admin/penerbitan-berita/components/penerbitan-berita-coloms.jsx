...
import ButtonDelete from "@/pages/admin/penerbitan-berita/components/alert-dialog";
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex gap-2">
          ...
          >
            <Link to={`/admin/penerbitan-berita/${id}?edit=true`}>
          ...
          <Button
            asChild
            size="icon"
            id={`btn-detail-penerbitan-berita-${id}`}
            className="bg-[#166648] hover:bg-[#166648]/80"
            style={{ boxShadow: "0px 4px 4px 0px #00000040" }}
          >
            <Link to={`/admin/penerbitan-berita/${id}`}>
